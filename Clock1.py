...
class RomanClock:
    def __init__(self, root):
        ...
        self.canvas = tk.Canvas(root, width=config["window_width"], height=config["window_width"], 
                                bg=config["background_color"], highlightthickness=0)
        self.canvas.pack()
        
        #w self.canvas = tk.Canvas(root, width=100, height=100, bg="black", highlightthickness=0)
        #w self.canvas.pack()
